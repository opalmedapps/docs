...
You can find the information for our demo environment on the [main user guide page](../../index.md#opaladmin).
...
![Opal Admin login page](images/oa_login_page.png)

## Main Menu

**Opal Admin** has a responsive design. If the user logs in while the webpage is displayed in a wide window, the user is directed to their Opal Admin main menu home page. What they see will depend on the roles and privileges granted to their user.
...
![Navigation menu dropdown view](images/navigation_dropdown_menu.png){width="50%"}

![Navigation menu hamburger view](images/navigation_hamburger_menu.png){width="50%"}

![Navigation menu hamburger dropdown view](images/navigation_hamburger_dropdown_menu.png){width="50%"}

### Questionnaires sub-menu

![Opal Admin questionnaire menu](images/questionnaire_menu.png)

### Patients sub-menu

![Opal Admin Patient menu](images/patient_menu.png)
...
![Opal Admin Account page](images/account_page.png)
